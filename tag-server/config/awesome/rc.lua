...
-- menu icon menu pdq 07-02-2012
 ...
 local f = io.popen('ln -sfn ' .. home_path .. 'Dropbox/Photos/wallpapers/' .. wall .. ' ' .. home_path .. '.config/awesome/themes/default/bg.png')
 awesome.restart()
 end
 local function wall_menu()
 local f = io.popen('ls -1 ' .. home_path .. 'Dropbox/Photos/wallpapers/')
 for l in f:lines() do
...
vicious.register(weather, vicious.widgets.weather, "Weather: ${city}. Sky: ${sky}. Temp: ${tempf}f Humid: ${humid}%. Wind: ${windmph} mph", 1200, "KBNA")
